...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'resultado', loadChildren: () => import('app/modules/cadastros/resultado/resultado.routes')},
            {path: 'socios', loadChildren: () => import('app/modules/cadastros/socios/socio.routes')},
            {path: 'outrasDespesas', loadChildren: () => import('app/modules/cadastros/outrasDespesas/outrasDespesas.routes')},
            {path: 'abastecimentos', loadChildren: () => import('app/modules/cadastros/abastecimentos/abastecimento.routes')},
            {path: 'voos', loadChildren: () => import('app/modules/cadastros/voos/voo.routes')},
