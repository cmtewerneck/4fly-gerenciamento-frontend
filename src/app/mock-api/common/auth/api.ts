...
export class AuthMockApi {
    ...
    registerHandlers(): void {
        ...
        this._fuseMockApiService
            ...
            .reply(({ request }) => {
                // Sign in successful
                if ((request.body.email === 'thiagowerneck1990@hotmail.com' && request.body.password === 'Vasco10@') || (request.body.email === 'cmtelopes@hotmail.com' && request.body.password === '163708')) 
                {
                    return [
                        200,
                        {
