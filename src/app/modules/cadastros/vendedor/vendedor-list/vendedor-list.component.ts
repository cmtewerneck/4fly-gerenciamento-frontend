...
export class VendedorListComponent implements OnInit, OnDestroy {
    ...
    productsTableColumns: string[] = ['nome', 'ativo', 'actions'];
    ...
    loadThiago() {
        this.isLoading = true;
        this._vendedorService.getAll().subscribe(result => {
    ...
    load() {
        this.isLoading = true;
        this._vendedorService.list(this.query).subscribe(result => {
    ...
    edit(id: string) {
        ...
        this.router.navigate(['/vendedores/atualizar/' + this.selectedId]);
    }

    delete(id: string) {
        this.isLoading = true;
        this._vendedorService.delete(id).subscribe(_ => {
    ...
    deletar(id: string) {
        ...
        const confirmation = this._fuseConfirmationService.open({
            ...
            message:
                'Tem certeza que deseja deletar o vendedor? Não será possível desfazer.',
            actions: {
                confirm: {
                    label: 'Deletar',
                },
