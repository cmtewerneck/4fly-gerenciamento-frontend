...
export class TripulanteListComponent implements OnInit, OnDestroy {
    ...
    productsTableColumns: string[] = ['nome', 'cpf', 'canac', 'telefone', 'actions'];
    ...
    loadThiago() {
        this.isLoading = true;
        this._tripulanteService.getAll().subscribe(result => {
            this.tripulantes = result;
            console.log("Tripulante: " + result);
    ...
    details(id: string) {
        ...
        this.router.navigate(['/tripulantes/details/' + this.selectedId]);
    }

    edit(id: string) {
        this.selectedId = id;

        this.router.navigate(['/tripulantes/atualizar/' + this.selectedId]);
    }
    ...
    deletar(id: string) {
        ...
        const confirmation = this._fuseConfirmationService.open({
            title: 'Deletar Tripulante',
            message:
                'Tem certeza que deseja deletar o tripulante? Não será possível desfazer.',
            actions: {
                confirm: {
                    label: 'Deletar',
                },
